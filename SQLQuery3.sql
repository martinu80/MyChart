...
SELECT (SELECT COUNT(*) from DATA_table WHERE TagTimeStamp BETWEEN '2022-07-23 00:00:23.000' and '2022-07-23 04:30:23.000') AS COUNT_ROWS,TagTimeStamp, Tag_3 AS Tag_1,Tag_2 AS Tag_2,Tag_1 AS Tag_3
FROM DATA_table
WHERE TagTimeStamp BETWEEN '2022-07-23 00:00:23.000' and '2022-07-23 04:30:23.000'

SELECT(SELECT COUNT(*) from DATA_table WHERE TagTimeStamp BETWEEN '2022-07-21 10:00:00' and '2022-07-27 10:00:00') AS COUNT_ROWS , TagTimeStamp, Tag_1 AS Tag_1,Tag_3 AS Tag_2,Tag_2 AS Tag_3 from DATA_table WHERE TagTimeStamp BETWEEN '2022-07-21 10:00:00' and '2022-07-21 10:00:00'